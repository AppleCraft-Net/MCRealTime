...
import live.applecraft.Updater.ReleaseType;
...
public class Main extends JavaPlugin implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(args.length != 1) {
				...
				p.sendMessage(ChatColor.GOLD + "E-Mail: " + ChatColor.GREEN + "mcrealtime@justmail.de");
				...
				p.sendMessage(ChatColor.GREEN + "+ Added version support 1.8 - 1.20.1.");
